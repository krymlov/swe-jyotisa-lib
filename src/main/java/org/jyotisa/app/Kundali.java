...
public class Kundali implements IKundali {
    ...
    @Override
    public IArudhaPadas arudhaPadas() {
        if (null != arudhaPadas) return arudhaPadas;
        return arudhaPadas = new ArudhaPadas(sweObjects);
    }
    ...
    public String toString() {
        ...
        builder.append("Ayanamsa: ").append(sweObjects
                ...
                .append(" UTC:").append(sweJulianDate().timeZone() < 0. ? '-' : '+')
                    .append(toDMS(sweJulianDate().timeZone(), true))
